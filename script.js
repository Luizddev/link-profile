...
const badgeUrls = {
    ...
    active_developer: 'https://cdn.discordapp.com/badge-icons/6bdc42827a38498929a4920da2099d99.png',
    ...
    document.getElementById('profilesGrid').innerHTML = `
        <div class="profile-card">
            ...
            <div class="social-links">
                <a href="https://steamcommunity.com/id/pendents/" target="_blank" class="social-link steam" title="g0d">
                ...
                <a href="https://www.tiktok.com/@llzwhty" target="_blank" class="social-link tiktok" title="TikTok">
    <svg width="24" height="27" viewBox="0 0 24 24">
        <path d="M12.667 0h3.09c.275 2.35 1.618 3.812 3.576 4.11v3.09c-1.786.09-3.302-.545-4.666-1.503v7.03c0 3.576-3.576 5.962-6.94 4.527-2.148-.917-3.334-3.364-2.91-5.59.41-2.162 2.322-3.858 4.554-3.98.412-.022.824.022 1.236.132v3.186c-.374-.124-.76-.168-1.146-.132-1.236.116-2.196 1.25-2.06 2.48.136 1.242 1.38 2.12 2.61 1.81.9-.226 1.52-1.062 1.52-2.002V0z"/>
    </svg>
</a>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    revealScreen.addEventListener('click', () => {
        ...
        setTimeout(() => {
            ...
            musicControl.style.transition = 'opacity 0.8s ease';
            
            viewerCount.style.opacity = '1';
            viewerCount.style.pointerEvents = 'auto';
            viewerCount.style.transition = 'opacity 0.8s ease';
